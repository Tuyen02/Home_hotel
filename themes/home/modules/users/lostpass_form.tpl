<form action="{FORM_ACTION}" method="post" onsubmit="return lostpass_validForm(this);" autocomplete="off" novalidate<!-- BEGIN: recaptcha3 --> data-recaptcha3="1"<!-- END: recaptcha3 -->>
    <div class="nv-info margin-bottom fs-5" data-default="{LANG.lostpass_info1}">{LANG.lostpass_info1}</div>
    <div class="form-detail">
        <div class="step1">
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon"><em class="fa fa-user fa-lg"></em></span>
                    <input type="text" class="ms-3 required form-control" placeholder="{GLANG.username_email}" value="" name="userField" maxlength="100" data-pattern="/^(.){3,}$/" onkeypress="validErrorHidden(this);" data-mess="{LANG.lostpass_no_info1}">
                </div>
            </div>
